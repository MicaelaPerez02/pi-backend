...
public class ProductController {
    ...
    public Set<ProductDTO> findAllProductsByCitiesName(@PathVariable ("cityName") String cityName) throws NotFoundException {
        return productService.findAllProductsByCitiesName(cityName);
    }*/
